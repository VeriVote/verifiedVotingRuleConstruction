...
proof -
  ...
  ultimately have
    ...
    by simp
  thus ?thesis
    unfolding seq_comp_alt_eq[symmetric]  sequential_composition.simps
    by metis
qed
...
next
  ...
  have "\<exists> a \<in> A. elect (m \<triangleright> n) A p = {a}"
    ...
    unfolding seq_comp_alt_eq[symmetric] non_electing_def sequential_composition.simps
    by metis
  ...
  show ?thesis
    ...
    unfolding non_electing_def seq_comp_alt_eq[symmetric] sequential_composition.simps
    by metis
qed
